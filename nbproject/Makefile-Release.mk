...
${OBJECTDIR}/src/AppSimon.o: src/AppSimon.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AppSimon.o src/AppSimon.cpp

${OBJECTDIR}/src/CtxLogo.o: src/CtxLogo.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CtxLogo.o src/CtxLogo.cpp

${OBJECTDIR}/src/CtxSimon.o: src/CtxSimon.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CtxSimon.o src/CtxSimon.cpp
